...
{
    private static final String DEFAULT_UUID = "26b040cc-d675-4868-a0ba-5ecdc60e3274";//good
//    private static final String DEFAULT_UUID = "00001101-0000-1000-8000-00805F9B34FB";
//    private static final String DEFAULT_UUID = "fa87c0d0-afac-11de-8a39-0800200c9a66";
        ...
        synchronized(DeviceUuidFactory.class)
        {
            if(uuid == null)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        if (!DEFAULT_UUID.equals(androidId))
                        {
    ...
    {
        return UUID.fromString(DeviceUuidFactory.DEFAULT_UUID);
    }
}
